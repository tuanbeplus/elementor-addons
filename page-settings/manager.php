<?php
namespace ElementorAddons\PageSettings;
...
class Page_Settings {
	...
	public function add_panel_tab() {
		Controls_Manager::add_tab( self::PANEL_TAB, __( 'New Tab', 'elementor-addons' ) );
	}
	...
	public function register_document_controls( $document ) {
		...
		$document->start_controls_section(
			'new_section',
			[
				'label' => __( 'Settings', 'elementor-addons' ),
				'tab' => self::PANEL_TAB,
			]
		);
		...
		$document->add_control(
			...
			[
				...
				'default' => __( 'Title', 'elementor-addons' ),
			]
		);
